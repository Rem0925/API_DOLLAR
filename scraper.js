            ...
            if (!isNaN(precioBCV) && !isNaN(precioBinanceStr)){
                ...
                switch(true){
                    case montoUsuarioBs > 0:
                        resultado.conversion.bcv_total_ves = (montoUsuarioBs / precioBCV).toFixed(2);
                        break;
                    case montoUsuarioUsd > 0:
                        resultado.conversion.bcv_total_usd = (precioBCV * montoUsuarioUsd).toFixed(2);
                        break;
